...
<body>
 ...
 <div class="container">
  <div class="row">
    <div class="col-12">
      <span class="badge badge-success text-uppercase text-left">users list</span>
    </div>
  </div>
</div>
      ...
      <table class="table table-hover table-bordered">
        ...
        <tr class="text-center">
            ...
            <td class="d-flex align-items-center justify-content-around">
              ...
              <form action="{{route('users.edit', ['id' => $users->id])}}" method="get">
                <button class="btn btn-sm btn-warning   rounded-0">
                  Edit
                </button>
              </form>
              <form action="#" method="get">
                <input type="hidden" name="_method" value="delete"> <input type="hidden" name="_token" value="a7vPxbjGNh3RObw6aF91gwhwOdsilhNLRVsLFSG6">
