...
<body>
  ...
  <div class="d-flex flex-row">
    <div class="col-12 px-0">
      <div class="d-flex flex-row align-items-center">
        ...
        <div class="col-10">
          <h1 class="text-center font-weight-bold text-uppercase">project demo</h1>
        </div>
        <div class="col-1"></div>
      </div>
    </div>
 ...
 <div class="container">
  <div class="row">
    <div class="col-12">
      <span class="badge badge-success text-uppercase text-left">create user</span>
    </div>
  </div>
</div>
  ...
  <div class="d-flex flex-row">
    <div class="col-12 px-0">
      <form action="#" method="post">
        <input type="hidden" name="_method" value="post"> <input type="hidden" name="_token" value="a7vPxbjGNh3RObw6aF91gwhwOdsilhNLRVsLFSG6">
        <div class="form-group ">
          <label class="text-uppercase font-weight-bold" for="name">Username</label>
        ...
        <div class="form-group ">
          <label class="text-uppercase font-weight-bold" for="name">Fullname</label>
          <input type="text" class="form-control rounded-0" id="fullname" placeholder="Fullname" name="fullname">
        </div>
        <div class="form-group ">
          <label class="text-uppercase font-weight-bold" for="name">Role</label>
        ...
        <div class="form-group ">
          <button type="submit" class="btn btn-danger text-uppercase rounded-0 font-weight-bold" name="submit">
            create
          </button>
        </div>
      </form>
  ...
  <div class="row">
    <div class="col-12">
      ...
      project demo
        ...
        <form action="{{asset('create-user')}}" method="get">
